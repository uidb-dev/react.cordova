_cc3‍.x([["cli",()=>cli]]);const fs = require("fs");
                ...
                reco.state.child_process.exec(
                    ...
                    , function (error, stdout, stderr) {
                        ...
                        if (!withTemplate) {
                            ...
                            // download("orchoban/react.cordova/templates", './', function (err) {
...
fs.readFile(args[1].substring(0,args[1].lastIndexOf(".bin")) + "templates\\empty\\index.js", function (err, data) {
    ...
    fs.writeFile( "./react-js/public/index.html", data.toString(), function (err) {
        if (err) {
