...
let reco = {
  constructor: args => {
    try {
      ...
      var clientArgsAfter = "";
      for (let index = 1; index < args.slice(2).length; index++) clientArgsAfter += args.slice(2)[index] + " ";
      reco.setState({
        clientArgsAfter: clientArgsAfter
      });
      //--
      let clientArgsAfter_Space = "";
      for (let index = 1; index < args.slice(2).length; index++) clientArgsAfter_Space += '"' + args.slice(2)[index] + '"' + ' ';
      reco.setState({
        clientArgsAfter_Space: clientArgsAfter_Space
      });
  ...
  build: () => {
    ...
    console.log();
    reco.state.child_process.exec('npm run build', {
      cwd: 'react-js'
      ...
      reco.state.callBack_replaceWwwRootDir = function () {
        ...
        reco.state.child_process.exec('cordova build ' + reco.state.clientArgsAfter, {
          maxBuffer: 5120 * 5120,
          cwd: 'cordova'
  ...
  init: async () => {
    ...
    reco.state.child_process.exec('npx create-react-app react-js', {
      cwd: dir
    }, function (error, stdout, stderr) {
      if (error) {
        reco.setState({
      ...
      reco.state.child_process.exec(withTemplate ? 'npm i react.cordova-navigation_controller react-browser-notifications' : 'npm i react.cordova-navigation_controller', {
        cwd: dir + "/react-js"
      }, function (error, stdout, stderr) {
        if (error) {
          reco.setState({
      ...
      reco.state.child_process.exec('npm i cordova_script', {
        cwd: dir
      }, function (error, stdout, stderr) {
        if (error) {
          reco.setState({
        ...
        fs.copyFile(reco.state.args[1].substring(0, reco.state.args[1].lastIndexOf(".bin")) + "templates\\" + "package.json", dir + '/package.json', err => {
          if (err) {
        ...
        fs.readdir(reco.state.args[1].substring(0, reco.state.args[1].lastIndexOf(".bin")) + "templates\\" + template, (err, files) => {
          if (err) console.log(err);else files.forEach(file => {
            if (fs.existsSync(dir + "/react-js/src/" + file)) fs.unlink(dir + "/react-js/src/" + file, err => {
        ...
        console.log();
        reco.state.child_process.exec('cordova create cordova ' + reco.state.clientArgsAfter_Space, {
          cwd: dir
        }, function (error, stdout, stderr) {
          if (error) {
            reco.setState({
          ...
          reco.state.child_process.exec('cordova platform add android', {
            cwd: dir + '/cordova'
          }, function (error, stdout, stderr) {
            if (error) {
              reco.setState({
            ...
            reco.state.child_process.exec('cordova platform add ios', {
              cwd: dir + '/cordova'
            }, function (error, stdout, stderr) {
              if (error) {
                reco.setState({
              ...
              reco.state.child_process.exec('cordova platform add browser', {
                cwd: dir + '/cordova'
              }, function (error, stdout, stderr) {
                if (error) {
                  reco.setState({
                ...
                reco.state.child_process.exec('cordova platform ls', {
                  cwd: dir + '/cordova'
                }, function (error, stdout, stderr) {
                  if (error) {
                    reco.setState({
                  ...
                  if (withTemplate) {
                    reco.state.child_process.exec('cordova plugin add cordova-plugin-local-notification', {
                      cwd: dir + '/cordova'
                    }, function (error, stdout, stderr) {
                      if (error) {
                        reco.setState({
  ...
  //------------------------------------react------------------------------------//
  react: () => {
    reco.state.child_process.exec('npm ' + reco.state.clientArgsAfter, {
      cwd: 'react-js'
    }, function (error, stdout, stderr) {
      if (error) {
        reco.setState({
  ...
  //------------------------------------react start------------------------------------//
  reactStart: () => {
    reco.state.child_process.exec('npm start', {
      cwd: 'react-js'
    }, function (error, stdout, stderr) {
      if (error) {
        reco.setState({
  ...
  //------------------------------------react test------------------------------------//
  reactTest: () => {
    reco.state.child_process.exec('npm test', {
      cwd: 'react-js'
    }, function (error, stdout, stderr) {
      if (error) {
        reco.setState({
  ...
  //------------------------------------react install------------------------------------//
  reactInstall: () => {
    reco.state.child_process.exec('npm i ' + reco.state.clientArgsAfter, {
      cwd: 'react-js'
    }, function (error, stdout, stderr) {
      if (error) {
        reco.setState({
  ...
  //------------------------------------react uninstall------------------------------------//
  reactUninstall: () => {
    reco.state.child_process.exec('npm uninstall ' + reco.state.clientArgsAfter, {
      cwd: 'react-js'
    }, function (error, stdout, stderr) {
      if (error) {
        reco.setState({
  ...
  //------------------------------------cordova------------------------------------//
  cordova: () => {
    reco.state.child_process.exec('cordova ' + reco.state.clientArgsAfter, {
      cwd: 'cordova'
    }, function (error, stdout, stderr) {
      if (error) {
        reco.setState({
  ...
  //------------------------------------cordovaPlugin------------------------------------//
  cordovaPlugin: () => {
    reco.state.child_process.exec('cordova plugin ' + reco.state.clientArgsAfter, {
      cwd: 'cordova'
    }, function (error, stdout, stderr) {
      if (error) {
        reco.setState({
  ...
  //------------------------------------cordovaPlatform------------------------------------//
  cordovaPlatform: () => {
    reco.state.child_process.exec('cordova platform ' + reco.state.clientArgsAfter, {
      cwd: 'cordova'
    }, function (error, stdout, stderr) {
      if (error) {
        reco.setState({
  ...
  bundleServe: () => {
    ...
    reco.state.child_process.exec('cordova serve 8597', {
      cwd: 'cordova'
    }, function (error) {
      if (error) {
        reco.setState({
  ...
  recoFiles: dir => {
    ...
    fs.readFile(dir + "/react-js/public/index.html", function (err, data) {
      ...
      dataString = dataString.replace(dataString.substr(dataString.indexOf(`<meta name="viewport"`), dataString.substr(dataString.indexOf(`<meta name="viewport"`)).indexOf("/>") + 2), ` <meta name="viewport" content="user-scalable=no, initial-scale=1, maximum-scale=1, minimum-scale=1, width=device-width, shrink-to-fit=no" />`);
  ...
  version: automatic => {
    reco.state.child_process.exec('npm view react.cordova --json'
    // , { cwd: 'react-js' }
    , function (error, stdout, stderr) {
      if (error) {
        reco.setState({
      ...
      jsonfile.readFile(file).then(obj => {
        ...
        ╭─────────────────────────────────────────────╮
        │                                             │
        │   `), `Update available ${thisVersion} → `, colors.green(newVersion), colors.cyan(`         │
        │   `), `Run`, colors.blue(`npm i -g react.cordova`), ` to update`, colors.cyan(`   │
        │                                             │
        ╰─────────────────────────────────────────────╯
