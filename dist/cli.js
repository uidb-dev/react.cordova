...
export function cli(args) {
  ...
  if (fs.existsSync("./react")) fs.renameSync(`./react`, `./react-js`, function (error, stdout, stderr) {
    if (error) {
  ...
  if (fs.existsSync("package.json") && !fs.existsSync("./cordova") && !fs.existsSync("./react-js") || args.slice(2)[0] === "init" || args.slice(2)[0] === "version" || args.slice(2)[0] === "help") {
